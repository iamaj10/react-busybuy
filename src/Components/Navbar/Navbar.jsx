    ...
    <>
        <nav className={styles.nav}>
            <NavLink to="/" className={styles.logo}>
                ...
                <svg xmlns="http://www.w3.org/2000/svg" width="40" height="40" fill="currentColor" class="bi bi-luggage" viewBox="0 0 16 16">
                    ...
                    <>
                        ...
                        <NavLink to='/orders' className={styles.btn}>
                            <span>
                                ...
                                <span className={styles.text} style={{marginLeft:'5px'}}>My Orders</span>
                        </NavLink>
